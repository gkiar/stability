...
baseopts="-v ${datapath}:${datapath} --cluster slurm --clusterargs account:rpp-aevans-ab,time:04:00:00,mem:8192 -V --simg ${HOME}/gkiar-dipy_tracking-v0.4.0.simg "
...
# clowdr local dipy_tracking.json ${invodir} ${clowdir} ${baseopts} -g 20 --sweep "random_seed"
# 
# ### Launch simulation tasks
# invodir="./invocations-multi_seed"
# clowdir="/home/gkiar/executions/nkirs/multi_seed/mca/"
# clowdr local dipy_tracking.json ${invodir} ${clowdir} ${baseopts} -g 5 --sweep "random_seed" --sweep "output_directory"
